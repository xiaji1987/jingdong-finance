...
export default {
  computed: {
    ...mapState({
      dataMenu: state => state.menuLeft.dataMenu
    })
  },
  created () {
    this.$store.dispatch('menuLeft/getAllMenuLeft')
  }
}
</script>
...
.menuLeft
  ...
  .menuList
    ...
    left 0
    z-index 182
    background url(//static.360buyimg.com/finance/index/3.0.0/static/img/nav-bg.45c130d.png) no-repeat
    .list
      position absolute
      bottom 0px
      font-size 14px
